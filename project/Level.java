...
public class Level{
    protected int floor;
    protected ParkingSpot[] spots;	//number of spots in each level, including large, compact and motorcycle size
    protected int availableSpots = 0;	//number of free spots
    protected static final int SPOT_PER_ROW = 10;
